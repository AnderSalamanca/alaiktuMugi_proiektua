...
CREATE TABLE `administraria` (
  ...
  CONSTRAINT `fk_administraria_langilea1` FOREIGN KEY (`langilea_idlangilea`) REFERENCES `langilea` (`idlangilea`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `bezeroa` (
  ...
  CONSTRAINT `fk_bezeroa_erabiltzailea1` FOREIGN KEY (`erabiltzailea_iderabiltzailea`) REFERENCES `erabiltzailea` (`iderabiltzailea`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `bezeroa` VALUES (1,'Aitor','López',3),(2,'Maialen','Berasategi',23),(5,'Imanol','Zubiaurre',26);
...
CREATE TABLE `bidaiak` (
  ...
  CONSTRAINT `fk_bidaiak_bezeroa1` FOREIGN KEY (`bezeroa_idbezeroa`) REFERENCES `bezeroa` (`idbezeroa`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_bidaiak_taxista1` FOREIGN KEY (`taxista_langilea_idlangilea`) REFERENCES `taxista` (`langilea_idlangilea`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `erabiltzailea` VALUES (1,'ander3223@gmail.com','pvlbtnse','administraria'),(2,'taxista@empresa.com','taxista123','taxista'),(3,'aitor@gmail.com','alejandro123','bezeroa'),(16,'asa@gmail.com','asa123','taxista'),(23,'maialen@gmail.com','$2y$10$SqfavxAUdYXbEq0z0A9/6uIPtJoddh9DdVRp3S','bezeroa'),(26,'imanol@gmail.com','$2y$10$icohkN7U1lT2so3VVw6GvebUKgrI02fo8y5.dd','bezeroa');
...
INSERT INTO `historiala` VALUES (3,'Donostia','Bilbao','2025-05-09','10:00:00','11:00:00','Amaituta',2,1,1,NULL),(4,'Beasain','Ataun','2025-05-15','12:37:00',NULL,'Ezeztatuta',NULL,1,2,NULL),(5,'Donostia','Bilbao','2025-05-09','10:00:00','12:49:48','Amaituta',2,1,1,5.00),(6,'Donostia','Bilbao','2025-05-09','10:00:00','13:10:27','Amaituta',2,1,1,152.36),(7,'Donostia','Bilbao','2025-05-09','10:00:00','13:11:36','Amaituta',2,1,1,153.28),(8,'Tolosa','Beasain','2025-05-15','13:20:00',NULL,'Ezeztatuta',NULL,1,3,NULL),(9,'Beasain','Ataun','2025-05-19','13:24:00','12:54:39','Amaituta',2,1,7,-23.48);
...
CREATE TABLE `langilea` (
  ...
  CONSTRAINT `fk_langilea_erabiltzailea1` FOREIGN KEY (`erabiltzailea_iderabiltzailea`) REFERENCES `erabiltzailea` (`iderabiltzailea`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `taxista` (
  ...
  `edukiera` int(11) NOT NULL,
  `egoera` varchar(45) NOT NULL,
  `langilea_idlangilea` int(11) NOT NULL,
  `tarifa` decimal(10,2) NOT NULL,
  PRIMARY KEY (`langilea_idlangilea`),
  CONSTRAINT `fk_taxista_langilea1` FOREIGN KEY (`langilea_idlangilea`) REFERENCES `langilea` (`idlangilea`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'alaiktumugi'
--
/*!50106 SET @save_time_zone= @@TIME_ZONE */ ;
/*!50106 DROP EVENT IF EXISTS `bidai_bukatuak_ezabatu` */;
DELIMITER ;;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;;
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `bidai_bukatuak_ezabatu` ON SCHEDULE EVERY 20 SECOND STARTS '2025-05-19 12:32:33' ON COMPLETION PRESERVE ENABLE DO DELETE FROM bidaiak
  WHERE egoera IN ('Amaituta', 'Ezeztatuta') */ ;;
...
-- Dump completed on 2025-05-21 11:51:36
